...
export class ListaAleatoria {
    ...
    /**
     * Inverte a lista - o primeiro elemento se torna o último e vice-versa
     * Implementação sem usar métodos predefinidos como reverse()
     */
    public inverte(): void {
        ...
        // Usar dois ponteiros para trocar elementos das extremidades
        let inicio = 0;
        ...
        while (inicio < fim) {
            ...
            // Mover os ponteiros para o centro
            inicio++;
            fim--;
        }
    }
    ...
    /**
     * Retorna a amplitude da lista (diferença entre maior e menor elemento)
     * @returns amplitude ou 0 se lista vazia
     */
    public amplitude(): number {
        ...
        if (this.elementos.length === 1) {
            return 0; // Amplitude de um elemento é 0
        }
     ...
     * @returns maior elemento ou null se lista vazia
     */
    public maiorElemento(): number | null {
        if (this.elementos.length === 0) {
            return null;
        }
     ...
     * @returns menor elemento ou null se lista vazia
     */
    public menorElemento(): number | null {
        if (this.elementos.length === 0) {
            return null;
        }
